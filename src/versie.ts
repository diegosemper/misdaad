/* -----------------------------------------------------------------
   ...
   Overgenomen uit DORST!, waar dit een echt probleem oploste. GitHub Pages
   stuurt index.html mee met Cache-Control: max-age=600. Een telefoon mag die
   dus tien minuten bewaren, en een app die op je beginscherm staat houdt hem
   soms nog veel langer vast. Het gevolg is dat een wijziging op de laptop wél
   te zien is en op de telefoon niet -- en dat je je scheel zoekt naar een fout
   die er niet meer is.
